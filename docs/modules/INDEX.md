...
- [apps/web profile page](module-web-profile.md) — `app/profile`, `app/actions/profile.ts`, `components/profile`, `lib/profile-api.ts`: the account's email/name/avatar mark, the name form behind a Server Action, and the dashboard's name-or-email greeting.
